...
import { ArrowLeft, Eye, EyeOff, GraduationCap, LoaderPinwheel } from "lucide-react";
import toast from "react-hot-toast";
import { studentStore } from "@/store/studentStore";
import { Link } from "react-router-dom";

const AddStudent = () => {
    const { addStudent, loading } = studentStore();
              ...
              <div className={"flex flex-col gap-6 lg:h-[70vh]"}>
                <Card className={"h-fit justify-center"}>
                  ...
                  <Link to="/">
                    ...
                    <CardDescription>
                      Only admins can register student accounts.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
