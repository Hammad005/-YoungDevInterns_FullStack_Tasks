...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "max-w-sm w-full mx-auto p-8 rounded-xl border border-[rgba(255,255,255,0.10)] dark:bg-[rgba(40,40,40,0.70)] bg-gray-100  group ",
        className
      )}>
      {children}
    </div>
...
export const CardSkeletonContainer = ({
  ...
  return (
    <div
      className={cn("z-40", className, showGradient &&
        "bg-transparent")}>
      {children}
    </div>
  );
...
const Container = ({
  ...
  return (
    <div
      className={cn(
        `h-16 w-16 flex items-center justify-center bg-[rgba(248,248,248,0.01)]
